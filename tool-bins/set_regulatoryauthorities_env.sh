#!/bin/bash
export ORG_CONTEXT=privateintellectual
export ORG_NAME=Privateintellectual
export CORE_PEER_LOCALMSPID= PrivateintellectualMSP
# Logging specifications
export FABRIC_LOGGING_SPEC=INFO
# Location of the core.yaml
export FABRIC_CFG_PATH=/workspaces/intellectualproperty/config/regulatoryauthorities
# Address of the peer
export CORE_PEER_ADDRESS=regulatoryauthorities.privateintellectual.com:7051
# Local MSP for the admin - Commands need to be executed as org admin
export CORE_PEER_MSPCONFIGPATH=/workspaces/intellectualproperty/config/crypto-config/peerOrganizations/privateintellectual.com/users/Admin@privateintellectual.com/msp
